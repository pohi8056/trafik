...
public class Simulation {
    ...
    /**
     * The main menu of the simulation. Welcomes and asks the user for values to be executed.
     * The input values are: length of main road, length of turning lane, red and green light periods,
     * amount of cars to be simulated and the simulation speed. 
     *
     * @return all input values as an integer array
     */
     ...
     * Flushes the terminal screen and initiates the simulation countdown. 
     */
